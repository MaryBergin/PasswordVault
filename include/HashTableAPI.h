...
typedef struct Node
{
	char key[25]; ///< integer that represents a piece of data in the table (eg 35->"hello")
...
typedef struct HTable
{
	...
	int (*hashFunction)(size_t tableSize, char key[25]); ///< function pointer to a function to hash the data
...
**/
HTable *createTable(size_t size, int (*hashFunction)(size_t tableSize, char key[25]),void (*destroyData)(void *data),void (*printData)(void *toBePrinted));
